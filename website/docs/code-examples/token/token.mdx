...
Replace `<your-dev-wallet-private-key>` with your **dev** private key
and `<token-module-address>` with the address of a token module you created with thirdweb.
...
async function getBalance() {
  try {
    ...
    console.error('Failed to check balance. Error:', error)
  }
}\n
getBalance()`}
</RunnableCode>
